	...
	<div>
		...
		<el-row class="search-box">
			<el-form :inline="true" class="demo-form-inline">
				<el-form-item>
					<el-select :loading="projTypeLoading" v-model="param.params.parameter.type" placeholder="项目类别">
					    <el-option 
		...
		<template>
			<el-table :data="projData" highlight-current-row @selection-change="handleSelectionChange">
				...
				<el-table-column prop="sno" label="监督注册号">
				</el-table-column>
				<el-table-column prop="cost" label="工程造价（万）" align="center">
				</el-table-column>
				<el-table-column prop="CreateDateStart" label="录入日期" :formatter="formatDate">
				</el-table-column>
		...
		<el-dialog title="修改项目基本资料" v-model="dialogFormProjbasicVisible">
			<el-form :model="formProjbasic">
				...
				<el-form-item label="中标工程名" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.zbgcm"></el-input>
				</el-form-item>
				<el-form-item label="别名" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.bname"></el-input>
				</el-form-item>
				<el-form-item label="注册监督号" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.sno"></el-input>
				</el-form-item>
				<el-form-item label="责任书编号" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.zno"></el-input>
				</el-form-item>
				<el-form-item label="建设工程规划许可证" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.sgno"></el-input>
				</el-form-item>
				<el-form-item label="竣工备案号" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.jgno"></el-input>
				</el-form-item>
				<el-form-item label="临时项目" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.istemp"></el-input>
				</el-form-item>
				<el-form-item label="项目用途" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.purpose"></el-input>
				</el-form-item>
				<el-form-item label="项目类别" :label-width="basicLabelWidth" class="el-col-12">
				...
				<el-form-item label="监管类别" :label-width="basicLabelWidth" class="el-col-12">
				...
				<el-form-item label="项目造价（万元）" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.cost"></el-input>
				</el-form-item>
				<el-form-item label="总投资" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.invest"></el-input>
				</el-form-item>
				<el-form-item label="项目进度" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.progress"></el-input>
				</el-form-item>
				<el-form-item label="主体阶段" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.ztjd"></el-input>
				</el-form-item>
				<el-form-item label="当前阶段" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.dqjd"></el-input>
				</el-form-item>
				<el-form-item label="建设规模" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.squre"></el-input>
				</el-form-item>
				<el-form-item label="道路面积" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.djmj"></el-input>
				</el-form-item>
				<el-form-item label="桥梁面积" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.qlmj"></el-input>
				</el-form-item>
				<el-form-item label="轨道长度" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.gdcd"></el-input>
				</el-form-item>
				<el-form-item label="项目地址" :label-width="basicLabelWidth" class="el-col-12">
					<el-input v-model="formProjbasic.parameter.addr"></el-input>
				</el-form-item>
				<el-form-item label="开工日期" :label-width="basicLabelWidth" class="el-col-12">
					<el-date-picker v-model="formProjbasic.parameter.startdate" type="date"  placeholder="选择日期" :picker-options="pickerOptions0">
					</el-date-picker>
				</el-form-item>
				<el-form-item label="竣工日期" :label-width="basicLabelWidth" class="el-col-12">
					<el-date-picker v-model="formProjbasic.parameter.cmpdate" type="date"  placeholder="选择日期" :picker-options="pickerOptions1">
					</el-date-picker>
				</el-form-item>
				<el-form-item label="所属辖区" :label-width="basicLabelWidth" class="el-col-24">
					<v-region 
					:province="formProjbasic.parameter.province" 
					:city="formProjbasic.parameter.city" 
					:area="formProjbasic.parameter.area" 
					@emitRegionChange="regionChange"
					>
					</v-region>
				</el-form-item>
				<el-form-item label="质量目标" :label-width="basicLabelWidth" class="el-col-24">
				...
				<el-form-item label="申报资料" :label-width="basicLabelWidth" class="el-col-24">
					<el-radio-group v-model="formProjbasic.parameter.sbzl">
	...
	export default {
		...
		methods: {
			...
			regionChange: function(selectedObj){
				this.formProjbasic.parameter.province = selectedObj.province
				this.formProjbasic.parameter.city = selectedObj.city
				this.formProjbasic.parameter.area = selectedObj.area
			}
		}
	}
</script>