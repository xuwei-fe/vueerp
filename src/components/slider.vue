       ...
       <template  v-if="!sliderinit.loop">
        <template  v-for="item in pages">
      	 <div class="slider-item" :style="item.style">
        	<a href="javascript:;">
            <img :src="item.src" alt="" :height="item.height" :width="item.width">
          </a>
       	  </div>
        </template>
       </template>
      <!-- 无缝滚动 -->
       <template  v-if="sliderinit.loop">
        <div class="slider-item" :style="pages[pages.length-1].style">
          <a href="javascript:;">
              <img :src="pages[pages.length-1].src" alt="" :height="pages[pages.length-1].height" :width="pages[pages.length-1].width">
            </a>
        </div>
         <template  v-for="item in pages">
          <div class="slider-item" :style="item.style">
        ...
        <div class="slider-item" :style="pages[0].style">
            <a href="javascript:;">
              <img :src="pages[0].src" alt="" :height="pages[pages.length-1].height" :width="pages[pages.length-1].width">
            </a>
        </div>
       </template>
      </div>
